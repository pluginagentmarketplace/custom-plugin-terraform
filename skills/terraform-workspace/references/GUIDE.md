...
This guide provides comprehensive documentation for the **terraform-workspace** skill in the custom-plugin-terraform plugin.
...
```bash
# Invoke the skill
claude "terraform-workspace - [your task description]"

# Example
claude "terraform-workspace - analyze the current implementation"
```
...
def implement_terraform_workspace(input_data):
    """
    Implement terraform-workspace functionality.
