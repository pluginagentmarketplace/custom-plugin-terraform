...
This guide provides comprehensive documentation for the **terraform-gcp** skill in the custom-plugin-terraform plugin.
...
```bash
# Invoke the skill
claude "terraform-gcp - [your task description]"

# Example
claude "terraform-gcp - analyze the current implementation"
```
...
def implement_terraform_gcp(input_data):
    """
    Implement terraform-gcp functionality.
