...
This guide provides comprehensive documentation for the **terraform-aws** skill in the custom-plugin-terraform plugin.
...
```bash
# Invoke the skill
claude "terraform-aws - [your task description]"

# Example
claude "terraform-aws - analyze the current implementation"
```
...
def implement_terraform_aws(input_data):
    """
    Implement terraform-aws functionality.
