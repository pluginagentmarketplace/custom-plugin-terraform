...
This guide provides comprehensive documentation for the **terraform-modules** skill in the custom-plugin-terraform plugin.
...
```bash
# Invoke the skill
claude "terraform-modules - [your task description]"

# Example
claude "terraform-modules - analyze the current implementation"
```
...
def implement_terraform_modules(input_data):
    """
    Implement terraform-modules functionality.
