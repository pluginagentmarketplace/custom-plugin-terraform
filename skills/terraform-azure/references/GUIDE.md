# Terraform Azure Guide

## Overview

This guide provides comprehensive documentation for the **terraform-azure** skill in the custom-plugin-terraform plugin.
...
```bash
# Invoke the skill
claude "terraform-azure - [your task description]"

# Example
claude "terraform-azure - analyze the current implementation"
```
...
def implement_terraform_azure(input_data):
    """
    Implement terraform-azure functionality.
