...
This guide provides comprehensive documentation for the **terraform-providers** skill in the custom-plugin-terraform plugin.
...
```bash
# Invoke the skill
claude "terraform-providers - [your task description]"

# Example
claude "terraform-providers - analyze the current implementation"
```
...
def implement_terraform_providers(input_data):
    """
    Implement terraform-providers functionality.
