...
This guide provides comprehensive documentation for the **terraform-fundamentals** skill in the custom-plugin-terraform plugin.
...
```bash
# Invoke the skill
claude "terraform-fundamentals - [your task description]"

# Example
claude "terraform-fundamentals - analyze the current implementation"
```
...
def implement_terraform_fundamentals(input_data):
    """
    Implement terraform-fundamentals functionality.
