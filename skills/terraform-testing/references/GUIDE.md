...
This guide provides comprehensive documentation for the **terraform-testing** skill in the custom-plugin-terraform plugin.
...
```bash
# Invoke the skill
claude "terraform-testing - [your task description]"

# Example
claude "terraform-testing - analyze the current implementation"
```
...
def implement_terraform_testing(input_data):
    """
    Implement terraform-testing functionality.
