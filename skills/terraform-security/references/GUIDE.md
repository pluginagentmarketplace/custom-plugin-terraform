...
This guide provides comprehensive documentation for the **terraform-security** skill in the custom-plugin-terraform plugin.
...
```bash
# Invoke the skill
claude "terraform-security - [your task description]"

# Example
claude "terraform-security - analyze the current implementation"
```
...
def implement_terraform_security(input_data):
    """
    Implement terraform-security functionality.
